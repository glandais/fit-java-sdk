/////////////////////////////////////////////////////////////////////////////////////////////
// Converted from DiveAlarmMesg.java (Garmin FIT SDK 21.205.0) by converter/convert.py.
...
open class DiveAlarmMesg : Mesg {
    ...
    companion object {
        ...
        val diveAlarmMesg: Mesg = run {
            // dive_alarm
            val diveAlarmMesg = Mesg("dive_alarm", MesgNum.DIVE_ALARM)
            diveAlarmMesg.addField(Field("message_index", MessageIndexFieldNum, 132, 1.0, 0.0, "", false, Profile.Type.MESSAGE_INDEX))
            diveAlarmMesg.addField(Field("depth", DepthFieldNum, 134, 1000.0, 0.0, "m", false, Profile.Type.UINT32))
            diveAlarmMesg.addField(Field("time", TimeFieldNum, 133, 1.0, 0.0, "s", false, Profile.Type.SINT32))
            diveAlarmMesg.addField(Field("enabled", EnabledFieldNum, 0, 1.0, 0.0, "", false, Profile.Type.BOOL))
            diveAlarmMesg.addField(Field("alarm_type", AlarmTypeFieldNum, 0, 1.0, 0.0, "", false, Profile.Type.DIVE_ALARM_TYPE))
            diveAlarmMesg.addField(Field("sound", SoundFieldNum, 0, 1.0, 0.0, "", false, Profile.Type.TONE))
            diveAlarmMesg.addField(Field("dive_types", DiveTypesFieldNum, 0, 1.0, 0.0, "", false, Profile.Type.SUB_SPORT))
            diveAlarmMesg.addField(Field("id", IdFieldNum, 134, 1.0, 0.0, "", false, Profile.Type.UINT32))
            diveAlarmMesg.addField(Field("popup_enabled", PopupEnabledFieldNum, 0, 1.0, 0.0, "", false, Profile.Type.BOOL))
            diveAlarmMesg.addField(Field("trigger_on_descent", TriggerOnDescentFieldNum, 0, 1.0, 0.0, "", false, Profile.Type.BOOL))
            diveAlarmMesg.addField(Field("trigger_on_ascent", TriggerOnAscentFieldNum, 0, 1.0, 0.0, "", false, Profile.Type.BOOL))
            diveAlarmMesg.addField(Field("repeating", RepeatingFieldNum, 0, 1.0, 0.0, "", false, Profile.Type.BOOL))
            diveAlarmMesg.addField(Field("speed", SpeedFieldNum, 133, 1000.0, 0.0, "mps", false, Profile.Type.SINT32))
            diveAlarmMesg
        }
    }
