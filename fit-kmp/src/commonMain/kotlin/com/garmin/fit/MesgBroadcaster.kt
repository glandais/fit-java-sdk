/////////////////////////////////////////////////////////////////////////////////////////////
// Converted from MesgBroadcaster.java (Garmin FIT SDK 21.205.0) by converter/convert.py.
// Do NOT edit: re-run `python3 converter/convert.py` to regenerate.
/////////////////////////////////////////////////////////////////////////////////////////////
package com.garmin.fit


open class MesgBroadcaster(private val decode: Decode) : MesgListener, MesgDefinitionListener, MesgSource {
    ...
    private val mesgDefinitionListeners = ArrayList<MesgDefinitionListener>()
    private val fileIdMesgListeners = ArrayList<FileIdMesgListener>()
    private val fileCreatorMesgListeners = ArrayList<FileCreatorMesgListener>()
    private val timestampCorrelationMesgListeners = ArrayList<TimestampCorrelationMesgListener>()
    private val softwareMesgListeners = ArrayList<SoftwareMesgListener>()
    private val slaveDeviceMesgListeners = ArrayList<SlaveDeviceMesgListener>()
    private val capabilitiesMesgListeners = ArrayList<CapabilitiesMesgListener>()
    private val fileCapabilitiesMesgListeners = ArrayList<FileCapabilitiesMesgListener>()
    private val mesgCapabilitiesMesgListeners = ArrayList<MesgCapabilitiesMesgListener>()
    private val fieldCapabilitiesMesgListeners = ArrayList<FieldCapabilitiesMesgListener>()
    private val deviceSettingsMesgListeners = ArrayList<DeviceSettingsMesgListener>()
    private val userProfileMesgListeners = ArrayList<UserProfileMesgListener>()
    private val hrmProfileMesgListeners = ArrayList<HrmProfileMesgListener>()
    private val sdmProfileMesgListeners = ArrayList<SdmProfileMesgListener>()
    private val bikeProfileMesgListeners = ArrayList<BikeProfileMesgListener>()
    private val connectivityMesgListeners = ArrayList<ConnectivityMesgListener>()
    private val watchfaceSettingsMesgListeners = ArrayList<WatchfaceSettingsMesgListener>()
    private val ohrSettingsMesgListeners = ArrayList<OhrSettingsMesgListener>()
    private val timeInZoneMesgListeners = ArrayList<TimeInZoneMesgListener>()
    private val zonesTargetMesgListeners = ArrayList<ZonesTargetMesgListener>()
    private val sportMesgListeners = ArrayList<SportMesgListener>()
    private val hrZoneMesgListeners = ArrayList<HrZoneMesgListener>()
    private val speedZoneMesgListeners = ArrayList<SpeedZoneMesgListener>()
    private val cadenceZoneMesgListeners = ArrayList<CadenceZoneMesgListener>()
    private val powerZoneMesgListeners = ArrayList<PowerZoneMesgListener>()
    private val metZoneMesgListeners = ArrayList<MetZoneMesgListener>()
    private val trainingSettingsMesgListeners = ArrayList<TrainingSettingsMesgListener>()
    private val diveSettingsMesgListeners = ArrayList<DiveSettingsMesgListener>()
    private val diveAlarmMesgListeners = ArrayList<DiveAlarmMesgListener>()
    private val diveApneaAlarmMesgListeners = ArrayList<DiveApneaAlarmMesgListener>()
    private val diveGasMesgListeners = ArrayList<DiveGasMesgListener>()
    private val goalMesgListeners = ArrayList<GoalMesgListener>()
    private val activityMesgListeners = ArrayList<ActivityMesgListener>()
    private val sessionMesgListeners = ArrayList<SessionMesgListener>()
    private val lapMesgListeners = ArrayList<LapMesgListener>()
    private val lengthMesgListeners = ArrayList<LengthMesgListener>()
    private val recordMesgListeners = ArrayList<RecordMesgListener>()
    private val eventMesgListeners = ArrayList<EventMesgListener>()
    private val deviceInfoMesgListeners = ArrayList<DeviceInfoMesgListener>()
    private val deviceAuxBatteryInfoMesgListeners = ArrayList<DeviceAuxBatteryInfoMesgListener>()
    private val trainingFileMesgListeners = ArrayList<TrainingFileMesgListener>()
    private val weatherConditionsMesgListeners = ArrayList<WeatherConditionsMesgListener>()
    private val weatherAlertMesgListeners = ArrayList<WeatherAlertMesgListener>()
    private val gpsMetadataMesgListeners = ArrayList<GpsMetadataMesgListener>()
    private val cameraEventMesgListeners = ArrayList<CameraEventMesgListener>()
    private val gyroscopeDataMesgListeners = ArrayList<GyroscopeDataMesgListener>()
    private val accelerometerDataMesgListeners = ArrayList<AccelerometerDataMesgListener>()
    private val magnetometerDataMesgListeners = ArrayList<MagnetometerDataMesgListener>()
    private val barometerDataMesgListeners = ArrayList<BarometerDataMesgListener>()
    private val threeDSensorCalibrationMesgListeners = ArrayList<ThreeDSensorCalibrationMesgListener>()
    private val oneDSensorCalibrationMesgListeners = ArrayList<OneDSensorCalibrationMesgListener>()
    private val videoFrameMesgListeners = ArrayList<VideoFrameMesgListener>()
    private val obdiiDataMesgListeners = ArrayList<ObdiiDataMesgListener>()
    private val nmeaSentenceMesgListeners = ArrayList<NmeaSentenceMesgListener>()
    private val aviationAttitudeMesgListeners = ArrayList<AviationAttitudeMesgListener>()
    private val videoMesgListeners = ArrayList<VideoMesgListener>()
    private val videoTitleMesgListeners = ArrayList<VideoTitleMesgListener>()
    private val videoDescriptionMesgListeners = ArrayList<VideoDescriptionMesgListener>()
    private val videoClipMesgListeners = ArrayList<VideoClipMesgListener>()
    private val setMesgListeners = ArrayList<SetMesgListener>()
    private val jumpMesgListeners = ArrayList<JumpMesgListener>()
    private val splitMesgListeners = ArrayList<SplitMesgListener>()
    private val splitSummaryMesgListeners = ArrayList<SplitSummaryMesgListener>()
    private val climbProMesgListeners = ArrayList<ClimbProMesgListener>()
    private val fieldDescriptionMesgListeners = ArrayList<FieldDescriptionMesgListener>()
    private val developerDataIdMesgListeners = ArrayList<DeveloperDataIdMesgListener>()
    private val courseMesgListeners = ArrayList<CourseMesgListener>()
    private val coursePointMesgListeners = ArrayList<CoursePointMesgListener>()
    private val segmentIdMesgListeners = ArrayList<SegmentIdMesgListener>()
    private val segmentLeaderboardEntryMesgListeners = ArrayList<SegmentLeaderboardEntryMesgListener>()
    private val segmentPointMesgListeners = ArrayList<SegmentPointMesgListener>()
    private val segmentLapMesgListeners = ArrayList<SegmentLapMesgListener>()
    private val segmentFileMesgListeners = ArrayList<SegmentFileMesgListener>()
    private val workoutMesgListeners = ArrayList<WorkoutMesgListener>()
    private val workoutSessionMesgListeners = ArrayList<WorkoutSessionMesgListener>()
    private val workoutStepMesgListeners = ArrayList<WorkoutStepMesgListener>()
    private val exerciseTitleMesgListeners = ArrayList<ExerciseTitleMesgListener>()
    private val scheduleMesgListeners = ArrayList<ScheduleMesgListener>()
    private val totalsMesgListeners = ArrayList<TotalsMesgListener>()
    private val weightScaleMesgListeners = ArrayList<WeightScaleMesgListener>()
    private val bloodPressureMesgListeners = ArrayList<BloodPressureMesgListener>()
    private val monitoringInfoMesgListeners = ArrayList<MonitoringInfoMesgListener>()
    private val monitoringMesgListeners = ArrayList<MonitoringMesgListener>()
    private val monitoringHrDataMesgListeners = ArrayList<MonitoringHrDataMesgListener>()
    private val spo2DataMesgListeners = ArrayList<Spo2DataMesgListener>()
    private val hrMesgListeners = ArrayList<HrMesgListener>()
    private val stressLevelMesgListeners = ArrayList<StressLevelMesgListener>()
    private val maxMetDataMesgListeners = ArrayList<MaxMetDataMesgListener>()
    private val hsaBodyBatteryDataMesgListeners = ArrayList<HsaBodyBatteryDataMesgListener>()
    private val hsaEventMesgListeners = ArrayList<HsaEventMesgListener>()
    private val hsaAccelerometerDataMesgListeners = ArrayList<HsaAccelerometerDataMesgListener>()
    private val hsaGyroscopeDataMesgListeners = ArrayList<HsaGyroscopeDataMesgListener>()
    private val hsaStepDataMesgListeners = ArrayList<HsaStepDataMesgListener>()
    private val hsaSpo2DataMesgListeners = ArrayList<HsaSpo2DataMesgListener>()
    private val hsaStressDataMesgListeners = ArrayList<HsaStressDataMesgListener>()
    private val hsaRespirationDataMesgListeners = ArrayList<HsaRespirationDataMesgListener>()
    private val hsaHeartRateDataMesgListeners = ArrayList<HsaHeartRateDataMesgListener>()
    private val hsaConfigurationDataMesgListeners = ArrayList<HsaConfigurationDataMesgListener>()
    private val hsaWristTemperatureDataMesgListeners = ArrayList<HsaWristTemperatureDataMesgListener>()
    private val memoGlobMesgListeners = ArrayList<MemoGlobMesgListener>()
    private val sleepLevelMesgListeners = ArrayList<SleepLevelMesgListener>()
    private val antChannelIdMesgListeners = ArrayList<AntChannelIdMesgListener>()
    private val antRxMesgListeners = ArrayList<AntRxMesgListener>()
    private val antTxMesgListeners = ArrayList<AntTxMesgListener>()
    private val exdScreenConfigurationMesgListeners = ArrayList<ExdScreenConfigurationMesgListener>()
    private val exdDataFieldConfigurationMesgListeners = ArrayList<ExdDataFieldConfigurationMesgListener>()
    private val exdDataConceptConfigurationMesgListeners = ArrayList<ExdDataConceptConfigurationMesgListener>()
    private val diveSummaryMesgListeners = ArrayList<DiveSummaryMesgListener>()
    private val aadAccelFeaturesMesgListeners = ArrayList<AadAccelFeaturesMesgListener>()
    private val hrvMesgListeners = ArrayList<HrvMesgListener>()
    private val beatIntervalsMesgListeners = ArrayList<BeatIntervalsMesgListener>()
    private val hrvStatusSummaryMesgListeners = ArrayList<HrvStatusSummaryMesgListener>()
    private val hrvValueMesgListeners = ArrayList<HrvValueMesgListener>()
    private val rawBbiMesgListeners = ArrayList<RawBbiMesgListener>()
    private val respirationRateMesgListeners = ArrayList<RespirationRateMesgListener>()
    private val chronoShotSessionMesgListeners = ArrayList<ChronoShotSessionMesgListener>()
    private val chronoShotDataMesgListeners = ArrayList<ChronoShotDataMesgListener>()
    private val tankUpdateMesgListeners = ArrayList<TankUpdateMesgListener>()
    private val tankSummaryMesgListeners = ArrayList<TankSummaryMesgListener>()
    private val sleepAssessmentMesgListeners = ArrayList<SleepAssessmentMesgListener>()
    private val sleepDisruptionSeverityPeriodMesgListeners = ArrayList<SleepDisruptionSeverityPeriodMesgListener>()
    private val sleepDisruptionOvernightSeverityMesgListeners = ArrayList<SleepDisruptionOvernightSeverityMesgListener>()
    private val napEventMesgListeners = ArrayList<NapEventMesgListener>()
    private val skinTempOvernightMesgListeners = ArrayList<SkinTempOvernightMesgListener>()
    private val padMesgListeners = ArrayList<PadMesgListener>()
    ...
    override fun onMesg(mesg: Mesg) {
        ...
        when (mesg.getNum()) {
            ...
            MesgNum.SLEEP_DISRUPTION_OVERNIGHT_SEVERITY -> {
                ...
                val sleepDisruptionOvernightSeverityMesg = SleepDisruptionOvernightSeverityMesg(mesg)
