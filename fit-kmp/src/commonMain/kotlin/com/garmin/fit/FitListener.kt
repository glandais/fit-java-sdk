/////////////////////////////////////////////////////////////////////////////////////////////
// Converted from FitListener.java (Garmin FIT SDK 21.205.0) by converter/convert.py.
...
open class FitListener : MesgListener, DeveloperFieldDescriptionListener {
    ...
    @get:JvmName("fitMessagesProtected")
    protected val fitMessages = FitMessages()

    fun getFitMessages(): FitMessages {
        return fitMessages
    }
    ...
    override fun onMesg(mesg: Mesg) {
        when (mesg.getNum()) {
            ...
            MesgNum.TIMESTAMP_CORRELATION -> fitMessages._timestampCorrelationMesgs.add(TimestampCorrelationMesg(mesg))
            ...
            MesgNum.FILE_CAPABILITIES -> fitMessages._fileCapabilitiesMesgs.add(FileCapabilitiesMesg(mesg))
            MesgNum.MESG_CAPABILITIES -> fitMessages._mesgCapabilitiesMesgs.add(MesgCapabilitiesMesg(mesg))
            MesgNum.FIELD_CAPABILITIES -> fitMessages._fieldCapabilitiesMesgs.add(FieldCapabilitiesMesg(mesg))
            ...
            MesgNum.WATCHFACE_SETTINGS -> fitMessages._watchfaceSettingsMesgs.add(WatchfaceSettingsMesg(mesg))
            ...
            MesgNum.TRAINING_SETTINGS -> fitMessages._trainingSettingsMesgs.add(TrainingSettingsMesg(mesg))
            ...
            MesgNum.DEVICE_AUX_BATTERY_INFO -> fitMessages._deviceAuxBatteryInfoMesgs.add(DeviceAuxBatteryInfoMesg(mesg))
            MesgNum.TRAINING_FILE -> fitMessages._trainingFileMesgs.add(TrainingFileMesg(mesg))
            MesgNum.WEATHER_CONDITIONS -> fitMessages._weatherConditionsMesgs.add(WeatherConditionsMesg(mesg))
            ...
            MesgNum.ACCELEROMETER_DATA -> fitMessages._accelerometerDataMesgs.add(AccelerometerDataMesg(mesg))
            MesgNum.MAGNETOMETER_DATA -> fitMessages._magnetometerDataMesgs.add(MagnetometerDataMesg(mesg))
            MesgNum.BAROMETER_DATA -> fitMessages._barometerDataMesgs.add(BarometerDataMesg(mesg))
            MesgNum.THREE_D_SENSOR_CALIBRATION -> fitMessages._threeDSensorCalibrationMesgs.add(ThreeDSensorCalibrationMesg(mesg))
            MesgNum.ONE_D_SENSOR_CALIBRATION -> fitMessages._oneDSensorCalibrationMesgs.add(OneDSensorCalibrationMesg(mesg))
            ...
            MesgNum.AVIATION_ATTITUDE -> fitMessages._aviationAttitudeMesgs.add(AviationAttitudeMesg(mesg))
            ...
            MesgNum.VIDEO_DESCRIPTION -> fitMessages._videoDescriptionMesgs.add(VideoDescriptionMesg(mesg))
            ...
            MesgNum.FIELD_DESCRIPTION -> fitMessages._fieldDescriptionMesgs.add(FieldDescriptionMesg(mesg))
            MesgNum.DEVELOPER_DATA_ID -> fitMessages._developerDataIdMesgs.add(DeveloperDataIdMesg(mesg))
            ...
            MesgNum.SEGMENT_LEADERBOARD_ENTRY -> fitMessages._segmentLeaderboardEntryMesgs.add(SegmentLeaderboardEntryMesg(mesg))
            ...
            MesgNum.MONITORING_HR_DATA -> fitMessages._monitoringHrDataMesgs.add(MonitoringHrDataMesg(mesg))
            ...
            MesgNum.HSA_BODY_BATTERY_DATA -> fitMessages._hsaBodyBatteryDataMesgs.add(HsaBodyBatteryDataMesg(mesg))
            MesgNum.HSA_EVENT -> fitMessages._hsaEventMesgs.add(HsaEventMesg(mesg))
            MesgNum.HSA_ACCELEROMETER_DATA -> fitMessages._hsaAccelerometerDataMesgs.add(HsaAccelerometerDataMesg(mesg))
            MesgNum.HSA_GYROSCOPE_DATA -> fitMessages._hsaGyroscopeDataMesgs.add(HsaGyroscopeDataMesg(mesg))
            ...
            MesgNum.HSA_RESPIRATION_DATA -> fitMessages._hsaRespirationDataMesgs.add(HsaRespirationDataMesg(mesg))
            MesgNum.HSA_HEART_RATE_DATA -> fitMessages._hsaHeartRateDataMesgs.add(HsaHeartRateDataMesg(mesg))
            MesgNum.HSA_CONFIGURATION_DATA -> fitMessages._hsaConfigurationDataMesgs.add(HsaConfigurationDataMesg(mesg))
            MesgNum.HSA_WRIST_TEMPERATURE_DATA -> fitMessages._hsaWristTemperatureDataMesgs.add(HsaWristTemperatureDataMesg(mesg))
            ...
            MesgNum.EXD_SCREEN_CONFIGURATION -> fitMessages._exdScreenConfigurationMesgs.add(ExdScreenConfigurationMesg(mesg))
            MesgNum.EXD_DATA_FIELD_CONFIGURATION -> fitMessages._exdDataFieldConfigurationMesgs.add(ExdDataFieldConfigurationMesg(mesg))
            MesgNum.EXD_DATA_CONCEPT_CONFIGURATION -> fitMessages._exdDataConceptConfigurationMesgs.add(ExdDataConceptConfigurationMesg(mesg))
            MesgNum.DIVE_SUMMARY -> fitMessages._diveSummaryMesgs.add(DiveSummaryMesg(mesg))
            MesgNum.AAD_ACCEL_FEATURES -> fitMessages._aadAccelFeaturesMesgs.add(AadAccelFeaturesMesg(mesg))
            ...
            MesgNum.HRV_STATUS_SUMMARY -> fitMessages._hrvStatusSummaryMesgs.add(HrvStatusSummaryMesg(mesg))
            ...
            MesgNum.RESPIRATION_RATE -> fitMessages._respirationRateMesgs.add(RespirationRateMesg(mesg))
            MesgNum.CHRONO_SHOT_SESSION -> fitMessages._chronoShotSessionMesgs.add(ChronoShotSessionMesg(mesg))
            ...
            MesgNum.SLEEP_ASSESSMENT -> fitMessages._sleepAssessmentMesgs.add(SleepAssessmentMesg(mesg))
            MesgNum.SLEEP_DISRUPTION_SEVERITY_PERIOD -> fitMessages._sleepDisruptionSeverityPeriodMesgs.add(SleepDisruptionSeverityPeriodMesg(mesg))
            MesgNum.SLEEP_DISRUPTION_OVERNIGHT_SEVERITY -> fitMessages._sleepDisruptionOvernightSeverityMesgs.add(SleepDisruptionOvernightSeverityMesg(mesg))
            MesgNum.NAP_EVENT -> fitMessages._napEventMesgs.add(NapEventMesg(mesg))
            MesgNum.SKIN_TEMP_OVERNIGHT -> fitMessages._skinTempOvernightMesgs.add(SkinTempOvernightMesg(mesg))
