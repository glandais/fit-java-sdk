...
open class FitListener : MesgListener, DeveloperFieldDescriptionListener {
    ...
    override fun onMesg(mesg: Mesg) {
        when (mesg.getNum()) {
            ...
            MesgNum.TIMESTAMP_CORRELATION -> fitMessages.timestampCorrelationMesgs.add(TimestampCorrelationMesg(mesg))
            ...
            MesgNum.FILE_CAPABILITIES -> fitMessages.fileCapabilitiesMesgs.add(FileCapabilitiesMesg(mesg))
            MesgNum.MESG_CAPABILITIES -> fitMessages.mesgCapabilitiesMesgs.add(MesgCapabilitiesMesg(mesg))
            MesgNum.FIELD_CAPABILITIES -> fitMessages.fieldCapabilitiesMesgs.add(FieldCapabilitiesMesg(mesg))
            ...
            MesgNum.WATCHFACE_SETTINGS -> fitMessages.watchfaceSettingsMesgs.add(WatchfaceSettingsMesg(mesg))
            ...
            MesgNum.TRAINING_SETTINGS -> fitMessages.trainingSettingsMesgs.add(TrainingSettingsMesg(mesg))
            ...
            MesgNum.DEVICE_AUX_BATTERY_INFO -> fitMessages.deviceAuxBatteryInfoMesgs.add(DeviceAuxBatteryInfoMesg(mesg))
            MesgNum.TRAINING_FILE -> fitMessages.trainingFileMesgs.add(TrainingFileMesg(mesg))
            MesgNum.WEATHER_CONDITIONS -> fitMessages.weatherConditionsMesgs.add(WeatherConditionsMesg(mesg))
            ...
            MesgNum.ACCELEROMETER_DATA -> fitMessages.accelerometerDataMesgs.add(AccelerometerDataMesg(mesg))
            MesgNum.MAGNETOMETER_DATA -> fitMessages.magnetometerDataMesgs.add(MagnetometerDataMesg(mesg))
            MesgNum.BAROMETER_DATA -> fitMessages.barometerDataMesgs.add(BarometerDataMesg(mesg))
            MesgNum.THREE_D_SENSOR_CALIBRATION -> fitMessages.threeDSensorCalibrationMesgs.add(ThreeDSensorCalibrationMesg(mesg))
            MesgNum.ONE_D_SENSOR_CALIBRATION -> fitMessages.oneDSensorCalibrationMesgs.add(OneDSensorCalibrationMesg(mesg))
            ...
            MesgNum.AVIATION_ATTITUDE -> fitMessages.aviationAttitudeMesgs.add(AviationAttitudeMesg(mesg))
            ...
            MesgNum.VIDEO_DESCRIPTION -> fitMessages.videoDescriptionMesgs.add(VideoDescriptionMesg(mesg))
            ...
            MesgNum.FIELD_DESCRIPTION -> fitMessages.fieldDescriptionMesgs.add(FieldDescriptionMesg(mesg))
            MesgNum.DEVELOPER_DATA_ID -> fitMessages.developerDataIdMesgs.add(DeveloperDataIdMesg(mesg))
            ...
            MesgNum.SEGMENT_LEADERBOARD_ENTRY -> fitMessages.segmentLeaderboardEntryMesgs.add(SegmentLeaderboardEntryMesg(mesg))
            ...
            MesgNum.MONITORING_HR_DATA -> fitMessages.monitoringHrDataMesgs.add(MonitoringHrDataMesg(mesg))
            ...
            MesgNum.HSA_BODY_BATTERY_DATA -> fitMessages.hsaBodyBatteryDataMesgs.add(HsaBodyBatteryDataMesg(mesg))
            MesgNum.HSA_EVENT -> fitMessages.hsaEventMesgs.add(HsaEventMesg(mesg))
            MesgNum.HSA_ACCELEROMETER_DATA -> fitMessages.hsaAccelerometerDataMesgs.add(HsaAccelerometerDataMesg(mesg))
            MesgNum.HSA_GYROSCOPE_DATA -> fitMessages.hsaGyroscopeDataMesgs.add(HsaGyroscopeDataMesg(mesg))
            ...
            MesgNum.HSA_RESPIRATION_DATA -> fitMessages.hsaRespirationDataMesgs.add(HsaRespirationDataMesg(mesg))
            MesgNum.HSA_HEART_RATE_DATA -> fitMessages.hsaHeartRateDataMesgs.add(HsaHeartRateDataMesg(mesg))
            MesgNum.HSA_CONFIGURATION_DATA -> fitMessages.hsaConfigurationDataMesgs.add(HsaConfigurationDataMesg(mesg))
            MesgNum.HSA_WRIST_TEMPERATURE_DATA -> fitMessages.hsaWristTemperatureDataMesgs.add(HsaWristTemperatureDataMesg(mesg))
            ...
            MesgNum.EXD_SCREEN_CONFIGURATION -> fitMessages.exdScreenConfigurationMesgs.add(ExdScreenConfigurationMesg(mesg))
            MesgNum.EXD_DATA_FIELD_CONFIGURATION -> fitMessages.exdDataFieldConfigurationMesgs.add(ExdDataFieldConfigurationMesg(mesg))
            MesgNum.EXD_DATA_CONCEPT_CONFIGURATION -> fitMessages.exdDataConceptConfigurationMesgs.add(ExdDataConceptConfigurationMesg(mesg))
            MesgNum.DIVE_SUMMARY -> fitMessages.diveSummaryMesgs.add(DiveSummaryMesg(mesg))
            MesgNum.AAD_ACCEL_FEATURES -> fitMessages.aadAccelFeaturesMesgs.add(AadAccelFeaturesMesg(mesg))
            ...
            MesgNum.HRV_STATUS_SUMMARY -> fitMessages.hrvStatusSummaryMesgs.add(HrvStatusSummaryMesg(mesg))
            ...
            MesgNum.RESPIRATION_RATE -> fitMessages.respirationRateMesgs.add(RespirationRateMesg(mesg))
            MesgNum.CHRONO_SHOT_SESSION -> fitMessages.chronoShotSessionMesgs.add(ChronoShotSessionMesg(mesg))
            ...
            MesgNum.SLEEP_ASSESSMENT -> fitMessages.sleepAssessmentMesgs.add(SleepAssessmentMesg(mesg))
            MesgNum.SLEEP_DISRUPTION_SEVERITY_PERIOD -> fitMessages.sleepDisruptionSeverityPeriodMesgs.add(SleepDisruptionSeverityPeriodMesg(mesg))
            MesgNum.SLEEP_DISRUPTION_OVERNIGHT_SEVERITY -> fitMessages.sleepDisruptionOvernightSeverityMesgs.add(SleepDisruptionOvernightSeverityMesg(mesg))
            MesgNum.NAP_EVENT -> fitMessages.napEventMesgs.add(NapEventMesg(mesg))
            MesgNum.SKIN_TEMP_OVERNIGHT -> fitMessages.skinTempOvernightMesgs.add(SkinTempOvernightMesg(mesg))
